CLOUD_AI = {
    ...
    "skills": {
        ...
        "Data Engineering": "ETL Pipelines, Airflow, dbt, FastAPI, Kafka, Redis",
    ...
    "experience": [
        {
            ...
            "bullets": [
                "Architected analytics-ready datasets and semantic layers for ML workflows",
                "Built Python + SQL ETL pipelines reducing manual effort by 35%",
                "Improved reporting efficiency by 20%",
                "Implemented data quality monitoring reducing issues by 40%",
        ...
        },
        {
            ...
            "bullets": [
                "Built real-time sentiment pipelines using Twitter/X and Reddit data",
                "Developed streaming pipelines using Kafka, Celery, Redis",
        ...
        },
        {
            ...
            "bullets": [
                ...
                "Built anomaly detection dashboards for monitoring"
            ]
        },
        {
            ...
            "bullets": [
                "Built computer vision models achieving 88% accuracy",
    ...
    "projects": [
        {
            ...
            "bullets": [
                "Designed multi-agent system using LangGraph and LangChain",
                "Built RAG pipelines with evaluation using RAGAS",
                "Integrated satellite and climate datasets",
                "Implemented LLM-based reasoning workflows"
            ],
            "tags": ["LangGraph", "LangChain", "RAG", "OpenAI"]
        },
        {
            "name": "Real-Time Sentiment Analytics Pipeline",
            "bullets": [
                "Built streaming pipelines using Kafka and Redis",
                "Processed real-time social media data",
                "Applied NLP models for sentiment analysis"
            ],
            "tags": ["Kafka", "Redis", "NLP"]
        },
        {
